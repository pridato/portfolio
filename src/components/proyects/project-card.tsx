...
const renderTagComponents = (tag:any) => {
  switch (tag) {
    case Tag.Angular:
      return <Angular />;
    case Tag.React:
...
const ProjectCard = ({ name, description, tags, github_url, image_url }:Project) => {
  return (
      ...
      <div className="card-container">
        ...
        <div className="wrapper">
          ...
          <a href={github_url} className='p-2' target='_blank'>
            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-github" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
